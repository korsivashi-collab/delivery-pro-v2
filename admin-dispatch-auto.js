...
// ==========================================
// 🌟 5. 할당 초기화 (관제 엑셀 배정 초기화 + 기사 스마트폰 앱 동선 완전 삭제 연동)
// ==========================================
export async function revertAutoDispatch() {
    ...
    // 2. 🌟 핵심: 기사 스마트폰 앱이 보고 있는 Firestore의 routes 문서도 일괄 삭제
    // 이 작업이 실행되면 기사 앱(index.html)의 감지기가 작동하여 즉시 빈 목록으로 자동 리셋됩니다.
    const visibleDrivers = getFilteredVisibleDrivers();
